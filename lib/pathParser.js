...
const pathParser = {
  ...
  getParams: function(ourPath, reqPath) {
    ...
    // if one of the elements is a dynamic param we can add that to results
    // return results object if we make it through, ex. { id: 10 }
    ...
    if (this.objNotEmpty(results)) return results;
  },
